...
|-------------------------|:--------------------------------------------------:|
|       README_CN.md      |   [中文文档(Chinese Document)](https://github.com/HwzLoveDz/AXP202-PMIC/blob/main/README_CN.md)     |
|       README.md      |   [英文文档(English Document)](https://github.com/HwzLoveDz/AXP202-PMIC/blob/main/README.md)        |
...
* 本模块**P2P兼容AXP209**电源管理芯片，程序也兼容，只是AXP209比AXP202多了一个OTP解码器，代码中操作寄存器即可
